...
async function main() {
  ...
  const configs = [
    ...
    { key: 'PAGO_MOVIL_PHONE',    value: '04141234567',      description: 'Teléfono para pago móvil' },
    { key: 'PAGO_MOVIL_BANK',     value: 'Banco de Venezuela', description: 'Banco receptor' },
    { key: 'PAGO_MOVIL_HOLDER',   value: 'NOMBRE TITULAR',  description: 'Nombre del titular de la cuenta' },
    { key: 'PAGO_MOVIL_RIF',      value: 'V-12345678',      description: 'RIF/Cédula del titular' },
    ...
    { key: 'ADMIN_PHONE',         value: '584141234567',    description: 'Número WhatsApp del admin (con código país sin +)' },
    { key: 'NOTIFICATION_PHONE',  value: '584141234567',    description: 'Número para notificaciones de pedidos' },
